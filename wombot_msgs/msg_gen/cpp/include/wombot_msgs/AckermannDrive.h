/* Auto-generated by genmsg_cpp for file /home/tscott/ros/wombot/wombot_msgs/msg/AckermannDrive.msg */
#ifndef WOMBOT_MSGS_MESSAGE_ACKERMANNDRIVE_H
#define WOMBOT_MSGS_MESSAGE_ACKERMANNDRIVE_H
#include <string>
#include <vector>
#include <map>
#include <ostream>
...
private:
  static const char* __s_getDataType_() { return "wombot_msgs/AckermannDrive"; }
public:
...
public:
  ...
  typedef boost::shared_ptr< ::wombot_msgs::AckermannDrive_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::wombot_msgs::AckermannDrive_<ContainerAllocator>  const> ConstPtr;
  boost::shared_ptr<std::map<std::string, std::string> > __connection_header;
}; // struct AckermannDrive
typedef  ::wombot_msgs::AckermannDrive_<std::allocator<void> > AckermannDrive;

typedef boost::shared_ptr< ::wombot_msgs::AckermannDrive> AckermannDrivePtr;
typedef boost::shared_ptr< ::wombot_msgs::AckermannDrive const> AckermannDriveConstPtr;


template<typename ContainerAllocator>
std::ostream& operator<<(std::ostream& s, const  ::wombot_msgs::AckermannDrive_<ContainerAllocator> & v)
{
  ros::message_operations::Printer< ::wombot_msgs::AckermannDrive_<ContainerAllocator> >::stream(s, "", v);
  return s;}
...
{
template<class ContainerAllocator> struct IsMessage< ::wombot_msgs::AckermannDrive_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::wombot_msgs::AckermannDrive_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
struct MD5Sum< ::wombot_msgs::AckermannDrive_<ContainerAllocator> > {
  static const char* value() 
  {
    return "3512e91b48d69674a0e86fadf1ea8231";
  }

  static const char* value(const  ::wombot_msgs::AckermannDrive_<ContainerAllocator> &) { return value(); } 
  static const uint64_t static_value1 = 0x3512e91b48d69674ULL;
  static const uint64_t static_value2 = 0xa0e86fadf1ea8231ULL;
};

template<class ContainerAllocator>
struct DataType< ::wombot_msgs::AckermannDrive_<ContainerAllocator> > {
  static const char* value() 
  {
    return "wombot_msgs/AckermannDrive";
  }
...
template<class ContainerAllocator>
struct Definition< ::wombot_msgs::AckermannDrive_<ContainerAllocator> > {
  static const char* value() 
  {
...
template<class ContainerAllocator> struct IsFixedSize< ::wombot_msgs::AckermannDrive_<ContainerAllocator> > : public TrueType {};
} // namespace message_traits
} // namespace ros
...
template<class ContainerAllocator> struct Serializer< ::wombot_msgs::AckermannDrive_<ContainerAllocator> >
{
...
template<class ContainerAllocator>
struct Printer< ::wombot_msgs::AckermannDrive_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const  ::wombot_msgs::AckermannDrive_<ContainerAllocator> & v) 
  {
...
#endif // WOMBOT_MSGS_MESSAGE_ACKERMANNDRIVE_H
