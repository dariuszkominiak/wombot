"""autogenerated by genmsg_py from DrivetrainCommand.msg. Do not edit."""
import roslib.message
import struct

import std_msgs.msg

class DrivetrainCommand(roslib.message.Message):
  _md5sum = "09da80225b8092c781124e80463cb389"
  _type = "wombot_msgs/DrivetrainCommand"
  _has_header = True #flag to mark the presence of a Header object
  _full_text = """# Wombot driveline control message
...
"""
  ...
  __slots__ = ['header','gear','front_diff','rear_diff']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,gear,front_diff,rear_diff
