"""autogenerated by genmsg_py from AckermannDriveStamped.msg. Do not edit."""
import roslib.message
import struct

import wombot_msgs.msg
import std_msgs.msg

class AckermannDriveStamped(roslib.message.Message):
  _md5sum = "1fd5d7f58889cefd44d29f6653240d0c"
  _type = "wombot_msgs/AckermannDriveStamped"
...
"""
  ...
  _slot_types = ['Header','wombot_msgs/AckermannDrive']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.drive is None:
        self.drive = wombot_msgs.msg.AckermannDrive()
    else:
      self.header = std_msgs.msg._Header.Header()
      self.drive = wombot_msgs.msg.AckermannDrive()
