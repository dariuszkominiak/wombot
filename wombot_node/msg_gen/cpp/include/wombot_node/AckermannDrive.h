/* Auto-generated by genmsg_cpp for file /home/tscott/ros/wombot/wombot_node/msg/AckermannDrive.msg */
#ifndef WOMBOT_NODE_MESSAGE_ACKERMANNDRIVE_H
#define WOMBOT_NODE_MESSAGE_ACKERMANNDRIVE_H
#include <string>
#include <vector>
#include <map>
#include <ostream>
...
private:
  static const char* __s_getDataType_() { return "wombot_node/AckermannDrive"; }
public:
...
public:
  ...
  typedef boost::shared_ptr< ::wombot_node::AckermannDrive_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::wombot_node::AckermannDrive_<ContainerAllocator>  const> ConstPtr;
  boost::shared_ptr<std::map<std::string, std::string> > __connection_header;
}; // struct AckermannDrive
typedef  ::wombot_node::AckermannDrive_<std::allocator<void> > AckermannDrive;

typedef boost::shared_ptr< ::wombot_node::AckermannDrive> AckermannDrivePtr;
typedef boost::shared_ptr< ::wombot_node::AckermannDrive const> AckermannDriveConstPtr;


template<typename ContainerAllocator>
std::ostream& operator<<(std::ostream& s, const  ::wombot_node::AckermannDrive_<ContainerAllocator> & v)
{
  ros::message_operations::Printer< ::wombot_node::AckermannDrive_<ContainerAllocator> >::stream(s, "", v);
  return s;}
...
{
template<class ContainerAllocator> struct IsMessage< ::wombot_node::AckermannDrive_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::wombot_node::AckermannDrive_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
struct MD5Sum< ::wombot_node::AckermannDrive_<ContainerAllocator> > {
  static const char* value() 
  {
    return "3512e91b48d69674a0e86fadf1ea8231";
  }

  static const char* value(const  ::wombot_node::AckermannDrive_<ContainerAllocator> &) { return value(); } 
  static const uint64_t static_value1 = 0x3512e91b48d69674ULL;
  static const uint64_t static_value2 = 0xa0e86fadf1ea8231ULL;
};

template<class ContainerAllocator>
struct DataType< ::wombot_node::AckermannDrive_<ContainerAllocator> > {
  static const char* value() 
  {
    return "wombot_node/AckermannDrive";
  }
...
template<class ContainerAllocator>
struct Definition< ::wombot_node::AckermannDrive_<ContainerAllocator> > {
  static const char* value() 
  {
...
template<class ContainerAllocator> struct IsFixedSize< ::wombot_node::AckermannDrive_<ContainerAllocator> > : public TrueType {};
} // namespace message_traits
} // namespace ros
...
template<class ContainerAllocator> struct Serializer< ::wombot_node::AckermannDrive_<ContainerAllocator> >
{
...
template<class ContainerAllocator>
struct Printer< ::wombot_node::AckermannDrive_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const  ::wombot_node::AckermannDrive_<ContainerAllocator> & v) 
  {
...
#endif // WOMBOT_NODE_MESSAGE_ACKERMANNDRIVE_H
